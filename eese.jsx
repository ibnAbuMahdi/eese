  ...
  for (const model of STRONG_MODELS) {
    try {
      ...
      if (res.ok) {
        ...
        console.warn(`Gemini model ${model} returned status ${res.status}, checking next model...`);
      }
    } catch (err) {
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
            <Tag text="AI: GEMINI PRO (FLAGSHIP)" color={T.teal} />
            <button
              onClick={() => {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 12 }}>
                  <div style={{
                    ...
                    background: T.amberGlow, border: `2px solid ${T.amber}`,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: 22, color: T.amber, fontWeight: 900, flexShrink: 0,
                  }}>
                    RM
                  </div>
                  <div>
                ...
                <p style={{
                  ...
                  Researcher and builder of EESE (Entrepreneurship Education Simulation Environment). Developer of Education technology products, contextual simulation platforms, and evidence-driven entrepreneurship pedagogies for African university ecosystems.
                </p>
              </div>
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontSize: 11, color: T.muted, letterSpacing: '0.08em', fontWeight: 600, marginBottom: 12 }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
                    <div style={{
                      ...
                      color: T.amber, fontWeight: 700, letterSpacing: '0.02em',
                    }}>
                      Cofounder atenda.ng
                    </div>
                    <div style={{
                    ...
                    <div style={{
                      background: `${T.teal}18`, border: `1px solid ${T.teal}`,
                      borderRadius: 20, padding: '7px 16px', fontSize: 13,
                      color: T.teal, fontWeight: 700, letterSpacing: '0.02em',
                    }}>
                      Author EEP Summary
                    </div>
                  </div>
      ...
      <section style={{ padding:'80px 24px 64px', textAlign:'center', borderBottom:`1px solid ${T.border}`, position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:1, maxWidth:700, margin:'0 auto' }}>
          ...
          <h1 style={{
            ...
            letterSpacing:'-0.04em', lineHeight:1, margin:'20px 0 10px',
            background:`linear-gradient(140deg,${T.text} 55%,${T.amber})`,
            WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text',
          }}>
            EESE
          </h1>
          <p style={{ fontSize:13, color:T.muted, letterSpacing:'0.06em', marginBottom:16 }}>
            Entrepreneurship Education Simulation Environment
          </p>
          <p style={{ fontSize:18, color:T.muted, lineHeight:1.65, maxWidth:540, margin:'0 auto 40px' }}>
      ...
      <section style={{ padding:'64px 24px', borderTop:`1px solid ${T.border}` }}>
        <div style={{ maxWidth:1120, margin:'0 auto' }}>
          <div style={{ textAlign:'center', marginBottom:40 }}>
            ...
            <p style={{ color:T.muted }}>EESE integrates into an existing entrepreneurship course — no curriculum overhaul required</p>
          </div>
      ...
      <section style={{ padding:'64px 24px', background:T.surface, borderTop:`1px solid ${T.border}`, textAlign:'center' }}>
        <div style={{ maxWidth:640, margin:'0 auto' }}>
          ...
          <div style={{ fontSize:12, color:T.faint }}>
            EESE is built at Federal University Birnin Kebbi and conducting its pilot at Bayero University Kano, 2026.
          </div>
        </div>
      </section>
